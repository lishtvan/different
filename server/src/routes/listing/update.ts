...
const schema = {
  ...
  body: {
    ...
    errorMessage: {
      required: {
        title: '/title Заголовок є обовʼязковим ',
        size: '/size Розмір є обовʼязковим ',
        designer: '/designer Дизайнер є обовʼязковим ',
        condition: '/condition Стан є обовʼязковим ',
        price: '/price Ціна є обовʼязковою ',
        category: '/category Категорія є обовʼязковою ',
        imageUrls: '/imageUrls Необхідно додати мінімум одну фотографію ',
        phone: '/phone Номер телефону є обовʼязковим ',
        cardNumber: '/cardNumber Номер карти є обовʼязковим',
      },
    },
    properties: {
